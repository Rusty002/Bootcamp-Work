...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $.ajax({
                url: 'http://localhost:5289/api/values',
                method: 'get',
                dataType: 'json',
                        ...
                        columns: [
                            ...
                            { "targets": 3, "data": "City", "sortable": true, "searchable": true },
                            {
                                ...
                                "render": function (data) {
                                    return '<button type="button" class="btn action-btn btn-primary btn-sm edit-btn" >Edit</button>' +' | ' + 
                                        '<button type="button" class="btn action-btn btn-danger btn-sm" >Delete</button>';
                                }
